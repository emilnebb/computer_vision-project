...
class RetinaNet(torch.nn.Module):
    ...
    def __init__(self,
        ...
        #ResNet
        self.resnet = torchvision.models.resnet18(pretrained=True, progress=True) #torchvision.models.resnet18(pretrained=True, progress=True)
        #Change output dimension of last fully conencted layer in the ResNet
